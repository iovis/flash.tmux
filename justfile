...
bench-search copies="500" iterations="50" runs="5": release
    ...
    hyperfine --warmup 2 --runs "{{ runs }}" --command-name rust-v0.2.2 "./target/release/search_bench $input {{ iterations }}"
...
bench-incremental copies="500" iterations="30" runs="5": release
    ...
    hyperfine --warmup 2 --runs "{{ runs }}" --command-name rust-v0.2.2 "./target/release/incremental_search_bench $input {{ iterations }}"
...
bench-render copies="300" iterations="20" runs="5": release
    ...
    hyperfine --warmup 2 --runs "{{ runs }}" --command-name rust-v0.2.2 "./target/release/render_incremental_search_bench $input {{ iterations }}"
